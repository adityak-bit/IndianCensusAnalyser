...
public class CensusAnalyserTest {
	...
	@Test
	public void givenIndianCensusCSVFile_CheckNumberOfRecordMatches() throws IOException, CSVBuilderException {
		try {
	...
	@Test
	public void givenIndianCensusCSVFile_IfIncorrectReturnsCustomException() throws IOException, CSVBuilderException {
		try {
	...
	@Test
	public void givenIndianCensusCSVFile_WhenCorrect_ButHeaderIncorrectReturnsCustomException() throws IOException, CSVBuilderException {
		try {
			CensusAnalyser censusAnalyser = new CensusAnalyser();
			ExpectedException exceptionRule = ExpectedException.none();
			exceptionRule.expect(CensusAnalyserException.class);
	...
	@Test
	public void givenIndianCensusCSVFile_WhenCorrect_ButDelimiterIncorrectReturnsCustomException() throws IOException, CSVBuilderException {
		try {
			CensusAnalyser censusAnalyser = new CensusAnalyser();
			ExpectedException exceptionRule = ExpectedException.none();
			exceptionRule.expect(CensusAnalyserException.class);
	...
	@Test
	public void givenIndianCensusCSVFile_WhenCorrect_ButTypeIncorrectReturnsCustomException() throws IOException, CSVBuilderException {
		try {
			CensusAnalyser censusAnalyser = new CensusAnalyser();
			ExpectedException exceptionRule = ExpectedException.none();
			exceptionRule.expect(CensusAnalyserException.class);
